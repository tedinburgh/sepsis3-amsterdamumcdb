...
combined_diagnoses = pd.read_csv(
    inputs.output_file_path + 'combined_diagnoses.csv')
...
sepsis.loc[~sepsis['admissionid'].duplicated(), diff_02_cols] = (
...
sepsis['infection'] = (
    sepsis['antibiotic_escalation'] & ~sepsis['prophylaxis'])
